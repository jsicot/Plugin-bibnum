...
class LiveBook {
    ...
    public static function get_table_of_content($item) {
        ...
        foreach ($files as $file) {
            ...
            if (preg_match($supportedFormatRegEx, $file->filename)) {
                ...
                $documentUrl = WEB_FILES . '/original/' . $file->filename;
                $documentfile = FILES_DIR . DIRECTORY_SEPARATOR . 'original' . DIRECTORY_SEPARATOR . $file->filename;
                ...
                // pour repérer les libellés des bookmarks
                $BookmarkLevel = '#BookmarkLevel: #';
                // pour repérer le niveau des bookmarks
                $BookmarkPageNumber = '#BookmarkPageNumber: #';
                // pour repérer le numéro de page du bookmark
     ...
     */
    private static function source_xml($item) {
